...
/***/ function(module, exports, __webpack_require__) {
	...
	var AboutPage = function (_Base) {
	  _inherits(AboutPage, _Base);

	  function AboutPage() {
	    _classCallCheck(this, AboutPage);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AboutPage).call(this));
	  ...
	  _createClass(AboutPage, null, [{
	    key: 'initializeAll',
	    value: function initializeAll(context) {
	      var options = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

	      document.querySelectorAll(AboutPage.Selectors.BASE).forEach(function (element) {
	        if (!AboutPage.Instances.has(element)) {
	          var instance = new AboutPage(element, options);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Module = function (_EventEmitter) {
	  ...
	  function Module() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Module).call(this));
	  }
